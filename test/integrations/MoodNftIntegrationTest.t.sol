...
contract MintMoodNft is Test {
    ...
    function testDefaultMintedNftIsHappy() public {
        vm.prank(USER);
        moodNft.mintNft();

        assert(moodNft.tokenIdToMood(0) == MoodNft.Mood.HAPPY);
    }
    ...
    function testFlipTokenToSad() public {
        ...
        assert(moodNft.tokenIdToMood(0) == MoodNft.Mood.SAD);
    }
}
